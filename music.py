...
def about_us():
    tkinter.messagebox.showinfo('About MusicPlayer', 'This is a music player build using Python Tkinter')
...
playlistbox = Listbox(leftframe, bg='pink')
playlistbox.pack()
...
rightframe = Frame(root, bg='pink')
rightframe.pack(pady=30)

topframe = Frame(rightframe, bg='pink')
topframe.pack()
...
middleframe = Frame(rightframe, bg='pink')
...
bottomframe = Frame(rightframe, bg='pink')
bottomframe.pack()
